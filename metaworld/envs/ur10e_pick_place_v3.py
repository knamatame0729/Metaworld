"""UR10e Pick and Place Environment V3."""
...
from Metaworld.metaworld.ur10e_xyz_env import UR10eXYZEnv
import numpy as np
import numpy.typing as npt
from gymnasium.spaces import Box
from scipy.spatial.transform import Rotation

from metaworld.ur10e_xyz_env import UR10eXYZEnv, RenderMode
from metaworld.types import InitConfigDict
from metaworld.utils import reward_utils


def full_ur10e_path_for(xml_name: str) -> str:
    """Returns the full path to a UR10e XML file."""
    return os.path.join(
...
class UR10ePickPlaceEnvV3(UR10eXYZEnv):
    """Pick and Place environment using UR10e robot."""
    ...
    def model_name(self) -> str:
        return full_ur10e_path_for("ur10e_xyz/ur10e_pick_and_place.xml")

    @UR10eXYZEnv._Decorators.assert_task_is_set
    def evaluate_state(
